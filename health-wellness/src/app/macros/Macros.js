...
const Macros = () => {
    ...
    const handleTypeChange =(e) => {
      ...
      <div className="card-info">
        <div className="text-title">Nutritional Profile</div>
        <div className="text-body">Introduce a new food item along with its nutritional information to be able to save and track it!</div>
      </div>
      <div className="card-footer">
      <div className="nutrition-add">
               <li> <input placeholder="Food Key" type='text' value={foodKeyInput} onChange={handleFoodKeyChange}></input></li>
               ...
               <li><input placeholder="Carbs" value={carbInput} onChange={handleCarbInputChange}></input></li>
               <li><input placeholder="Fat" value={fatInput} onChange={handleFatChange}></input></li>
               <li><input placeholder="Calories" value={calorieInput} onChange={handleCalorieChange}></input></li>
               <li><input placeholder="Type(carb/protein)" value={typeInput} onChange={handleTypeChange}></input></li>
               <div><button className="card-button" onClick={handleAddClick}>ADD</button></div>
               </div>
                
    </div></div>
    <div><a className="link" href='food'>Go Back to Macro Tracker</a></div>
            </div>
        )
    }
